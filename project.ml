...
let rec prodNaiveTest l = match l with
  | [] -> [] 
  | h::t -> time prod_naive h :: fullTest4 t;;

let rec prodFusionTest l = match l with
  | [] -> [] 
  | h::t -> time prod_fusion h :: fullTest5 t;;

let rec prodDivideTest l = match l with
  | [] -> [] 
  | h::t -> time prod_divide h :: fullTest6 t;;
...
let timeProdDivide2 = printTime prod_fusion arb2;;
let timeProdDivide3 = printTime prod_fusion arb3;;
let timeProdDivide4 = printTime prod_fusion arb4;;
let timeProdDivide5 = printTime prod_fusion arb5;;
let timeProdDivide6 = printTime prod_fusion arb6;;
let timeProdDivide7 = printTime prod_fusion arb7;;
let timeProdDivide8 = printTime prod_fusion arb8;;
let timeProdDivide9 = printTime prod_fusion arb9;;
let timeProdDivide10 = printTime prod_fusion arb10;;
*)
